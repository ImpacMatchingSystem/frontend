  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Excel 파일을 사용하여 {type === "companies" ? "기업" : "바이어"} 데이터를 일괄로 업로드할 수 있습니다.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
          <div>
            ...
            <p className="text-sm text-blue-700">올바른 형식의 Excel 템플릿을 다운로드하여 사용하세요.</p>
          </div>
          ...
          <div className="space-y-4">
            {results.success > 0 && (
              <Alert>
                ...
                <AlertDescription>
                  <strong>{results.success}개 항목</strong>이 성공적으로 업로드되었습니다.
                </AlertDescription>
              </Alert>
            )}
                  ...
                  <div>
                    ...
                    <ul className="mt-2 space-y-1 text-sm">
                      ...
                      {results.errors.length > 10 && (
                        <li className="text-gray-600">... 외 {results.errors.length - 10}개 오류</li>
                      )}
                    </ul>
                  </div>
                </AlertDescription>
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          ...
          <ol className="text-sm text-gray-600 space-y-1 list-decimal list-inside">
            <li>위의 "템플릿 다운로드" 버튼을 클릭하여 Excel 템플릿을 다운로드합니다.</li>
            <li>템플릿에 맞춰 데이터를 입력합니다.</li>
            <li>완성된 Excel 파일을 선택하고 "업로드 시작" 버튼을 클릭합니다.</li>
            <li>업로드 결과를 확인하고 오류가 있다면 수정 후 다시 업로드합니다.</li>
          </ol>
        </div>
      </CardContent>
    </Card>
