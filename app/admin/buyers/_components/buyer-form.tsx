      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="바이어 이름을 입력하세요" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                비밀번호 {isEditMode ? '(변경할 때만 입력)' : '*'}
              </FormLabel>
              <FormControl>
                <Input
                  type="password"
                  placeholder={isEditMode ? '변경하려면 새 비밀번호 입력' : ''}
                  {...field}
                />
              </FormControl>
              <FormMessage />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="url" placeholder="https://buyer.com" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="바이어에 대한 간단한 소개를 입력하세요"
                  {...field}
                />
              </FormControl>
              <FormMessage />
