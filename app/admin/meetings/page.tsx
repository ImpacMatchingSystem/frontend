  ...
  const filterMeetings = () => {
    ...
    if (dateFilter !== 'all') {
      ...
      switch (dateFilter) {
        ...
        case 'past':
          filtered = filtered.filter(meeting =>
            new Date(meeting.timeSlot.startTime) < today
          )
          break
      }
    }
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                            <div>
                              ...
                              {meeting.buyer.description && (
                                <p className="truncate">소개: {meeting.buyer.description}</p>
                              )}
                            </div>
                            <div>
                                      ...
                                      <div className="p-3 bg-gray-50 rounded-lg space-y-1">
                                        ...
                                        {selectedMeeting.company.website && (
                                          <p className="text-sm text-blue-600">
                                            <a 
                                              href={selectedMeeting.company.website} 
                                              target="_blank" 
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <div className="p-3 bg-gray-50 rounded-lg space-y-2">
                                      ...
                                      <div className="flex items-center justify-between">
                                        <span>신청일:</span>
                                        <span>
                                          {formatDateTime(selectedMeeting.createdAt).date}
                                        </span>
                                      </div>
                                      {selectedMeeting.updatedAt !== selectedMeeting.createdAt && (
                                        <div className="flex items-center justify-between">
                                          <span>수정일:</span>
                                          <span>
                                            {formatDateTime(selectedMeeting.updatedAt).date}
                                          </span>
                                        </div>
                                      )}
                                    </div>
